            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="/sell/seller/category/csave">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">名字</label>

                                <div class="col-sm-9">
                                    <input name="categoryName" type="text" id="form-field-1" value="${(category.categoryName)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="categoryType" type="text" id="form-field-2" value="${(category.categoryType)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
