                        ...
                        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a class="blue"
                                               href="/sell/seller/cproduct/modify?productId=${productInfo.productId}">
                                                <i > 修改</i>
                                            </a>
                                            <#if productInfo.getProductStatusEnum().message == "在架">
                                                <a class="red"
                                                   href="/sell/seller/cproduct/off_sale?productId=${productInfo.productId}">
                                                    <i >下架</i>
                                                </a>
                                                <#else>
                                                    <a class="red"
                                                       href="/sell/seller/cproduct/on_sale?productId=${productInfo.productId}">
                                                        <i>上架</i>
                                                    </a>
                                            </#if>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation">
                                    ...
                                    <#else>
                                        <li><a
                                                href="/sell/seller/cproduct/list?page=${currentPage-1}&size=${size}">上一页</a>
                                        </li>
                                    </#if>
                                    <#--小于10页全部显示-->
                                    <#if productInfoPage.getTotalPages() lte 10>
                                        <#list 1..productInfoPage.getTotalPages() as index>
                                            ...
                                            <#else>
                                                <li><a
                                                        href="/sell/seller/cproduct/list?page=${index}&size=${size}">${index}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                    </#if>
                                    ...
                                    <#--中间-->
                                        <#if currentPage == 4 >
                                            <li class="page-item active">
                                                <a class="page-link"
                                                   href="/sell/seller/cproduct/list?page=${currentPage}&size=${size}">${currentPage}</a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="#">...</a>
                                            </li>
                                        <#elseif currentPage == productInfoPage.getTotalPages()-3>
                                            <li class="page-item">
                                                <a class="page-link" href="#">...</a>
                                            </li>
                                            <li class="page-item active">
                                        ...
                                        <#elseif currentPage gt 4 && currentPage lt productInfoPage.getTotalPages()-3>
                                            <li class="page-item">
                                                <a class="page-link" href="#">...</a>
                                            </li>
                                            <li class="page-item active">
                                    ...
                                    <#--后3页-->
                                        <#list productInfoPage.getTotalPages()-2..productInfoPage.getTotalPages() as index>
                                            <#if currentPage == index>
                                                <li class="disabled"><a href="#">${index}</a></li>
                                            <#else>
                                                <li><a
                                    ...
                                    <#else>
                                        <li><a
                                                href="/sell/seller/cproduct/list?page=${currentPage +1}&size=${size}">下一页</a>
                                        </li>
                                    </#if>
                                    </ul>
                                </nav>
