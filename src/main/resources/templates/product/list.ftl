                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a class="blue"
                                               href="/sell/seller/product/modify?productId=${productInfo.productId}">
                                                <i > 修改</i>
                                            </a>
                                            <#if productInfo.getProductStatusEnum().message == "在架">
                                                <a class="red"
                                                   href="/sell/seller/product/off_sale?productId=${productInfo.productId}">
                                                    <i >下架</i>
                                                </a>
                                                <#else>
                                                    <a class="red"
                                                       href="/sell/seller/product/on_sale?productId=${productInfo.productId}">
                                                        <i>上架</i>
                                                    </a>
                                            </#if>
                                        </div>
                                    ...
                                    <#--中间-->
                                        <#if currentPage == 4 >
                                            <li class="page-item active">
                                                <a class="page-link"
                                                   href="/sell/seller/product/list?page=${currentPage}&size=${size}">${currentPage}</a>
                                            </li>
                                            <li class="page-item">
