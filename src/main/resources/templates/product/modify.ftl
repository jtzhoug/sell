                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" method="post" action="/sell/seller/product/save">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="productName" type="text" id="form-field-1" value="${(productInfo.productName)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="productPrice" type="text" id="form-field-2" value="${(productInfo.productPrice)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-3">库存</label>

                                <div class="col-sm-9">
                                    <input name="productStock" type="number" id="form-field-3" value="${(productInfo.productStock)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="productDescription" type="text" id="form-field-4" value="${(productInfo.productDescription)!''}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-5">类目</label>

                                <div class="col-sm-9">
                                <select name="categoryType" class="form-control" style="width: 245.92px">
                                <#list categoryList as categoryList>
                                    <option value="${(categoryList.categoryType)!''}"

                                        <#if (productInfo.categoryType)?? &&  productInfo.categoryType == categoryList.categoryType>
                                            selected
                                        </#if>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-6">图片</label>
                                <div class="col-sm-9">
                                <img height="100" width="100" src="${(productInfo.productIcon)!''}"></br>
                                <input name="productIcon" type="text" id="form-field-6" value="${(productInfo.productIcon)!''}"/>
                                </div>
                            </div>
                            <#--<div class="form-group">-->
